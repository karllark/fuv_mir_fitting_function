...
class G25(BaseExtModel, Fittable1DModel):
    ...
    bkg_center = Parameter(
        description="bkg: center", default=0.047, bounds=(0.03, 0.07), fixed=False
    )
    bkg_fwhm = Parameter(
    ...
    fuv_amp = Parameter(
        description="fuv: amplitude", default=3.35, bounds=(1.0, 100.0), fixed=False
    )
    fuv_center = Parameter(
        description="fuv: center", default=0.091, bounds=(0.06, 0.10), fixed=True
    )
    fuv_fwhm = Parameter(
        description="fuv: fwhm", default=0.039, bounds=(0.0, None), fixed=False
    )
...
class G25_FUV(BaseExtModel, Fittable1DModel):
    r"""
    Gordon (2024) parameter model.  Inspired by Pei (1992), Massa et al. (2020), and Gordon et al. (2021)
    ...
    fuv_amp = Parameter(description="FUV term: amplitude", default=3.5, min=0.0)
    ...
    fuv_b = Parameter(description="FUV term: b coefficient", default=4.0, bounds=(1.0, 20.0), fixed=False)
    fuv_n = Parameter(description="FUV term: n coefficient", default=6.5, bounds=(1.0, 100.0), fixed=False)
